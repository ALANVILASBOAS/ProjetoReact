...
function Home() {
    return (
        <>
            <Grid container direction="row" justifyContent="center" alignItems="center" style={{ backgroundColor: "#539DC7" }}>
                <Grid alignItems="center" item xs={6}>
                    <Box paddingX={3} >
                        <Typography variant="h3" gutterBottom color="textPrimary" component="h3" align="center" style={{ color: "#511B8A", fontWeight: "bold" }}>Seja bem vinde!</Typography>
                ...
                <Grid item xs={6} >
                    <img src="https://imgur.com/SijeGJT.png" alt="" width="500px" height="500px" />
                </Grid>
